...
function SmallCard({
  ...
  return (
    <div className="hover-3d">
      <div className="w-25 h-40 lg:w-40 lg:h-55 font-secondary border border-border-base rounded-lg shadow-sm overflow-hidden">
        {/* top half */}
        <div
        ...
        {/* bottom half */}
        <div className="flex flex-col items-center justify-center gap-2 h-20 sm:h-25 bg-base-200 text-center">
